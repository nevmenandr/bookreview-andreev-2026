...
**Цель:** Визуализация и интерпретация результатов сравнения подсчетов, выполненных на корпусе `author-corpus` (точной копии корпуса В. С. Андреева), с данными из монографии В. С. Андреева «"Пунцовой цифрою": Квантитативный анализ лирики Владимира Набокова».
